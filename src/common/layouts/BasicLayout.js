  ...
  render() {
    return (
        <Layout className="basic-layout">
          <Sider className={"sider"} trigger={null} collapsible collapsed={this.state.collapsed} width={256}>
            {/*<img src={Logo} />*/}
            {/*<Logo width={10} height={10} />*/}
            <div className="logo-title" id="logo">
              <a href="/">
                <img className="logo"
                     ...
                     alt="logo"/>
                {!this.state.collapsed ? <h1>Ant Design Pro</h1> : null}
              </a>
            </div>

            <Menu className={"menu"} theme="dark" mode="inline" defaultSelectedKeys={['1']}>
              <Menu.Item key="1">
                <NavLink to="/dashboard"><Icon type="dashboard"/><span>Dashboard</span></NavLink>
              </Menu.Item>
              <Menu.Item key="2">
                <NavLink to="/merchants"><Icon type="video-camera"/><span>Merchants</span></NavLink>
              </Menu.Item>
              <Menu.Item key="3">
                <NavLink to="/users"><Icon type="upload"/><span>Users</span></NavLink>
              </Menu.Item>
            </Menu>
          </Sider>
          <Layout>
            <Header className={"nav-header"}>
              ...
              <div className={"right-header"}>
                <Button className={"nav-action"} icon={"search"} type={"link"}/>
                <Dropdown overlay={
                  <Menu>
                    <Menu.Item>
                  ...
                  <Button className={"nav-action"} icon={"user"} type={"link"}>User</Button>
                </Dropdown>
              </div>
            </Header>
            <Content
